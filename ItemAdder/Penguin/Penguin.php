...
class Penguin extends CPClient implements PenguinInterface {
    ...
    public function addIgloo($intIgloo){
        $this->sendXt('s', 'g#au', $this->intInternalRoom, $intIgloo);
    }
    public function addFurn($intFurn){
        $this->sendXt('s', 'g#af', $this->intInternalRoom, $intFurn);
    }
    public function addLoc($intFurn){
        $this->sendXt('s', 'g#aloc', $this->intInternalRoom, $intFurn);
    }

    public function addFloor($intFloor){
        $this->sendXt('s', 'g#ag', $this->intInternalRoom, $intFloor);
    }
